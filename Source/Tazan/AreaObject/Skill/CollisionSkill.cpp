...
void UCollisionSkill::ProcessHitDetection(UAnimNotifyState* NotifyState)
{
	...
	//	{
	//		FVector location = (CurrentStartLocation + CurrentEndLocation) / 2.f;
	//		bHit = m_Caster->GetWorld()->SweepMultiByChannel(
	//			HitResults,
	//			location,
	//			location,
	//			CurrentSocketRotation.Quaternion(),
	//			ECC_GameTraceChannel2,
	...
	//if (bDebugDraw)
	//{
	//	DrawDebugHitDetection(NotifyState, CurrentStartLocation, CurrentEndLocation, HitResults, CurrentSocketRotation);
	//}
	//
	//if (!bHit)
	//{
